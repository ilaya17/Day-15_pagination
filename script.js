...
Previous.addEventListener('click', () => {
    num = [1, 2, 3]
    for (let z of num) {
        element = document.querySelector(`[for="${z}"]`)
...
function clicking(e){
    ...
    var data_element = document.createElement('p');
    var result = "";
    Object.entries(all_data[data-1]).forEach(([key,value])=>{
          result+=`
            <table>
              <thead>
                <tr>
